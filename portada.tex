...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        Integración FEM-PINN-FNO para simulación multiescala de materiales heterogéneos} \\[1.5cm]

        % Autor
        {\fontfamily{phv}\fontsize{20pt}{25pt}\selectfont
        Ing. Braian A. Desía} \\[1cm]
        ...
        \textbf{Director:} Dr. Ing. Benjamín A. Tourn (UNRaf)} \\[1cm]
        ...
        Ciudad Autónoma de Buenos Aires, julio de 2026} % Ejemplo: Ciudad de Córdoba, junio de 2025
    \end{flushright}
\end{titlepage}
